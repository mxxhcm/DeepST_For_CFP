...
def main():
    ...
    print("loading data...")
    ts = time.time()
    fname = os.path.join(DATAPATH, 'CACHE', 'TaxiDD3_C{}_P{}_T{}_no_external.h5'.format(
...
def test():
    ...
    if os.path.exists(fname) and CACHEDATA:
        ...
        X_train, Y_train, X_test, Y_test, mmn, external_dim, timestamp_train, timestamp_test = TaxiDD_3_frame.load_data(
